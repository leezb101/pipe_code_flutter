...
void main() {
  ...
  for (var testCase in testCases) {
    ...
    // 模拟我们在JsfAcceptanceCubit中的逻辑
    bool needCheckPurNm = _simulateSupplyTypeLogic(supplyType);
  ...
  print('\n=== 业务规则总结 ===');
  print('甲供材(0): 跳过purNm检查，直接正常进行');
  print('乙供材(1): 跳过purNm检查，直接正常进行');
  print('甲乙混供(2): 需要通过材料的purNm进行判断和提示');
}

/// 模拟JsfAcceptanceCubit中的供材类型判断逻辑
bool _simulateSupplyTypeLogic(ProjectSupplyType supplyType) {
  // 如果是"甲供材"，则不需要进行purNm判断
